...
export function CTASection() {
  return (
    <section className="py-24 sm:py-32 bg-gradient-to-b from-transparent to-red-900/50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white/10 backdrop-blur-md border border-rose-300/30 rounded-3xl p-12 sm:p-16 text-center hover:bg-white/15 transition">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link href="/properties">
              <Button className="bg-gradient-to-r from-rose-400 to-red-500 hover:from-rose-500 hover:to-red-600 text-red-950 font-bold text-lg px-8 py-6">
                Browse Properties
              </Button>
            </Link>
