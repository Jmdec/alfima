    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Georgia', serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .hero-tag { display: inline-block; font-family: 'DM Sans', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; color: #c9a84c; border: 1px solid rgba(201,168,76,0.4); padding: 6px 14px; margin-bottom: 20px; }
        .hero-headline { font-family: 'Cormorant Garamond', serif; font-size: 44px; font-weight: 400; color: #fff; line-height: 1.2; margin: 0 0 16px; }
        .hero-sub { font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 300; color: rgba(255,255,255,0.45); letter-spacing: 0.04em; margin: 0; }
        ...
        .heading-block p { font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 300; color: #8a7c6a; margin: 0; letter-spacing: 0.02em; }
        .error-box { display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: rgba(220,38,38,0.06); border: 1px solid rgba(220,38,38,0.18); border-radius: 2px; margin-bottom: 20px; }
        .error-box p { font-family: 'DM Sans', sans-serif; font-size: 13px; color: #dc2626; margin: 0; }
        .field { margin-bottom: 20px; }
        .field-label { display: block; font-family: 'DM Sans', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.18em; text-transform: uppercase; color: #8a7c6a; margin-bottom: 6px; }
        .field-input { width: 100%; background: #fff; border: 1px solid #ddd5c4; border-radius: 2px; padding: 11px 14px; font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 400; color: #1a1208; outline: none; transition: border-color 0.2s, box-shadow 0.2s; letter-spacing: 0.02em; }
        .field-input::placeholder { color: #c2b8a8; }
        .field-input:focus { border-color: #b8892e; box-shadow: 0 0 0 3px rgba(184,137,46,0.1); }
        .field-input:-webkit-autofill { -webkit-box-shadow: 0 0 0 1000px #fff inset !important; -webkit-text-fill-color: #1a1208 !important; }
        .pw-row { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
        .forgot-link { font-family: 'DM Sans', sans-serif; font-size: 11px; color: #b8892e; text-decoration: none; letter-spacing: 0.04em; }
        .forgot-link:hover { text-decoration: underline; }
        .pw-wrap { position: relative; }
        .pw-toggle { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #a89880; padding: 0; display: flex; }
        .submit-btn { width: 100%; padding: 13px; background: #1a1208; border: none; font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; color: #c9a84c; cursor: pointer; transition: background 0.2s, opacity 0.2s; margin-top: 4px; margin-bottom: 16px; border-radius: 2px; position: relative; overflow: hidden; }
        .submit-btn::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, transparent 40%, rgba(201,168,76,0.12) 100%); }
        ...
        .custom-check { width: 15px; height: 15px; border: 1px solid #c2b8a8; border-radius: 2px; flex-shrink: 0; background: #fff; display: flex; align-items: center; justify-content: center; transition: border-color 0.2s; }
        .remember-row:hover .custom-check { border-color: #b8892e; }
        .remember-label { font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 300; color: #8a7c6a; letter-spacing: 0.03em; }
        .divider { display: flex; align-items: center; gap: 12px; margin-bottom: 16px; }
        .divider-line { flex: 1; height: 1px; background: #e4dace; }
        .divider-text { font-family: 'DM Sans', sans-serif; font-size: 10px; color: #b0a090; letter-spacing: 0.14em; text-transform: uppercase; }
        .register-row { text-align: center; font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 300; color: #8a7c6a; margin: 0; }
        .register-row a { color: #b8892e; text-decoration: none; font-weight: 500; }
        .register-row a:hover { text-decoration: underline; }
        .top-accent { position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, #b8892e, #e8c96a, #b8892e); }
        ...
        <div className="hero-panel">
          ...
          <div className="hero-content">
            ...
            <div className="hero-stats">
              <div><div className="stat-num">500+</div><div className="stat-label">Agents</div></div>
              <div><div className="stat-num">12K+</div><div className="stat-label">Listings</div></div>
              <div><div className="stat-num">8</div><div className="stat-label">Regions</div></div>
            </div>
          </div>
        </div>
              ...
              <div className="field">
                ...
                <div className="pw-wrap">
                  <input className="field-input" type={showPassword ? 'text' : 'password'} name="password"
                    ...
                    required autoComplete="current-password" style={{ paddingRight: 40 }} />
  ...
  return (
    <Suspense fallback={
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#faf7f2' }}>
        <Loader2 style={{ width: 32, height: 32, color: '#b8892e', animation: 'spin 1s linear infinite' }} />
      </div>
    }>
      <LoginContent />
    </Suspense>
