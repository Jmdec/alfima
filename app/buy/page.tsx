...
export default function BuyPage() {
  ...
  const fetchProperties = async (filters?: any) => {
    setLoading(true);
    try {
      const params = new URLSearchParams({ listingType: 'buy' });
      if (filters) {
    ...
    <div className="w-full min-h-screen">
      ...
      <section className="py-20 sm:py-28 bg-gradient-to-b from-green-900/60 via-green-800/40 to-transparent relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-12">
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-4 text-balance">Properties for Sale</h1>
            <p className="text-green-100 text-xl max-w-2xl">
              Discover your dream property from thousands of premium listings across the best neighborhoods
            </p>
          </div>
